...
from verl.utils.device import get_resource_name, get_visible_devices_keyword, is_torch_npu_available, is_kunlun_available
...
class vLLMHttpServer:
    ...
    async def _sleep_hybrid(self):
        ...
        if self.lora_as_adapter or is_torch_npu_available(check_device=False) or is_kunlun_available:
            sleep_level = 1
        else:
            sleep_level = 2
